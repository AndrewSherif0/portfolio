          ...
          <div className="animate-fade-in-right space-y-6">
            <div>
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed">
                ...
                typically respond within 24 hours and am always excited to
            ...
            <div className="space-y-4">
              {contactMethods.map((method, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`p-3 rounded-lg bg-secondary ${method.color}`}
                    >
            ...
            {/* Location */}
            <a
              href="https://www.google.com/maps?q=30.061587,31.376218"
              target="_blank"
              rel="noopener noreferrer"
              className="skill-card flex items-center gap-4 cursor-pointer"
            >
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Cairo, Egypt Mostafa Nahas street ,Nacr city
                </p>
              </div>
            </a>
            ...
            <div className="mt-8 p-6 bg-gradient-to-br from-primary/10 to-accent/10 rounded-lg border border-primary/20">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Whether it's a full-stack project, front-end development, or
                exploring AI integrations, I'm here to help bring your ideas to
                life.
              </p>
              <Button
                variant="outline"
