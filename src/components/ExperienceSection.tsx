        ...
        <div className="mt-16 animate-fade-in-up">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-primary/20 rounded-full flex items-center justify-center mb-3 justify-self-center">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-primary/20 rounded-full flex items-center justify-center mb-3 justify-self-center">
                <Building2 className="w-8 h-8 text-primary block mx-auto justify-self-center" />
              </div>
              <h4 className="font-semibold text-foreground">2022</h4>
              <p className="text-sm text-muted-foreground">NSF Internship national steel fabrication</p>
            </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-primary/20 rounded-full flex items-center justify-center mb-3 justify-self-center">
                <CheckCircle className="w-8 h-8 text-primary justify-self-center" />
              </div>
